...
public class SnappyCompressWrapperTranscoderTest {
    ...
    private Logger log = LoggerFactory.getLogger(SnappyCompressWrapperTranscoderTest.class);

    @Mock
    private Transcoder<Object> wrappedTranscoder;

    private SnappyCompressWrapperTranscoder<Object> snappyCompressWrapperTranscoder;

    private byte[] dataBytes;

    @Before
    public void setUp() throws Exception {
        snappyCompressWrapperTranscoder = new SnappyCompressWrapperTranscoder<>(wrappedTranscoder);
        snappyCompressWrapperTranscoder.setCompressionThresholdByteLength(TEST_COMPRESSION_THRESHOLD_BYTE_LENGTH);
        snappyCompressWrapperTranscoder.setCompressionFlag(TEST_COMPRESSION_FLAG);
    ...
    public void encode_decode() throws Exception {
        ...
        log.debug("Original size : {}, snappy compressed size : {}", dataBytes.length, encodedCachedData.getData().length);
